...
log_and_save_metrics(overhead, original_table_size, encrypted_table_size, encryption_speed, r'C:\Users\akhal\OneDrive\Desktop\Projects\minsta\Logs_Analysis\metrics.csv')